...
/// Dispatches events to listeners using the Dart [Stream] API. The [EventService]
...
///
/// Not all events should be broadcasted through the [EventService] but only those of
/// general interest.
///
...
class EventService {
  ...
  /// completed.
  EventService({bool sync = false}) : _streamController = StreamController.broadcast(sync: sync);
  ...
  EventService.customController(StreamController controller) : _streamController = controller;
  ...
  /// Destroy this [EventService]. This is generally only in a testing context.
  ///
  void destroy() {
